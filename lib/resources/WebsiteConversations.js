...
function WebsiteConversations(crisp) {
   ...
   * @return Promise
   */
  this.findWithSearchText = function (websiteId, searchText, page) {
    // https://api.crisp.chat/v1/website/c499368a-7438-40b8-ae84-9125afe02a69/conversations/1?search_query=c2db5d6f-f2fa-480c-b265-4a6b6903c29e&search_type=text
    if (!page) {
      page = 0;
    }
    ...
    return crisp.get(crisp._prepareRestUrl(['website', websiteId, 'conversations', page]), query, {});
  };
  /**
   * get website conversations
   * @memberof WebsiteConversations
   ...
   * @return Promise
   */
  this.getList = function (websiteId, page, query) {
    if (!page) {
      page = 0;
    }
